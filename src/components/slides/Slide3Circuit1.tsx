...
export function Slide3Circuit1({ readings }: Slide3Props) {
  return (
    <div className="p-8 bg-gradient-to-br from-red-50 to-orange-50 min-h-96 flex flex-col justify-center">
      <div className="mb-8">
        <h2 className="text-4xl font-bold text-gray-900">Circuit 1</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg p-6 shadow-md border-2 border-red-200">
          ...
          <div className="flex items-baseline gap-2 mb-3">
            <span className="text-4xl font-bold text-red-600">
              {readings?.voltage_1.toFixed(2) || '—'}
            </span>
            <span className="text-lg text-gray-600">V</span>
          </div>
          <div className="h-1 bg-red-200 rounded-full"></div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-md border-2 border-orange-200">
          ...
          <div className="flex items-baseline gap-2 mb-3">
            <span className="text-4xl font-bold text-orange-600">
              {readings?.power_factor_1.toFixed(3) || '—'}
            </span>
          </div>
          <div className="h-1 bg-orange-200 rounded-full"></div>
        </div>
